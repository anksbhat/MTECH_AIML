...
> Contact Session 2 = *Mathematical Preliminaries* (see the companion file `module2_MathematicalPreliminaries_Beginner_Guide.md`) **+** *Machine Learning Workflow* (this file): Role of Data, Pre-processing/wrangling, Data-skewness removal (sampling), Model Training, Model Testing & performance metrics.

---

## How to use this guide
Same recipe as Module 1: **plain idea → definition → mental map → worked example → runnable Python.**
Diagrams are in `module2_images/`. Runnable code is in `module2_examples.py`.
...
![Pipeline](module2_images/m2_06_pipeline.png)
...
![Attribute types](module2_images/m2_01_attribute_types.png)
...
![IQR boxplot](module2_images/m2_02_iqr_boxplot.png)
...
![3-sigma](module2_images/m2_03_three_sigma.png)
...
![Sampling](module2_images/m2_05_sampling.png)
...
![Scaling](module2_images/m2_04_scaling.png)
...
*Companion file: `module2_MathematicalPreliminaries_Beginner_Guide.md` (linear algebra, calculus, probability, decision & information theory).*
